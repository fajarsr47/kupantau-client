"""
Django settings for pantauclient project.
...
# Menaikkan batas ukuran upload request body menjadi 10MB
...
SECRET_KEY = 'django-insecure-e-1jkw*c6l05kw#2r5(=@_l6p05qto&##@)bv+&=$ybg7m#bdj'
...
WSGI_APPLICATION = 'pantauclient.wsgi.application'
